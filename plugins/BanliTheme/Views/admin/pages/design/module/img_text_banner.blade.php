<template id="module-editor-img-text-banner-template">
  <div>
    <div class="module-edit-group">
      ...
      <div class="module-edit-title">{{ __('admin/builder.modules_select_image') }} / Video</div>
      <div class="pb-images-top">
        <pb-image-selector :is-alt="true"  v-model="module.image" :is-language="false"></pb-image-selector>
        <div class="tag">{{ __('admin/builder.text_suggested_size') }} 1000 x 600. Or upload an MP4 video instead.</div>
      </div>
