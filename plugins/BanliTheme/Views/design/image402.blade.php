<div class="module-item {{ $design ? 'module-item-design' : ''}}" id="module-{{ $module_id }}">
  <div class="module-image-402 banner-magnify-hover module-info  ">
      ...
      <div class="module-image-info d-grid grid-4">
        <div class="image-402-1">
          <a class="image-wrap" href="{{ $content['images'][0]['link']['link'] ?? '' }}">
            <img src="{{ $content['images'][0]['image'] }}" class="img-fluid" src="{{ $content['images'][0]['image_alt'] ?? '' }}">
        ...
        <div class="image-402-2">
          <a class="image-wrap" href="{{ $content['images'][1]['link']['link'] ?? '' }}">
            <img src="{{ $content['images'][1]['image'] }}" class="img-fluid" src="{{ $content['images'][1]['image_alt'] ?? '' }}">
        ...
        <div class="image-402-3">
          <a class="image-wrap" href="{{ $content['images'][2]['link']['link'] ?? '' }}">
            <img src="{{ $content['images'][2]['image'] }}" class="img-fluid" src="{{ $content['images'][2]['image_alt'] ?? '' }}">
        ...
        <div class="image-402-4">
          <a class="image-wrap" href="{{ $content['images'][3]['link']['link'] ?? '' }}">
            <img src="{{ $content['images'][3]['image'] }}" class="img-fluid" src="{{ $content['images'][3]['image_alt'] ?? '' }}">
