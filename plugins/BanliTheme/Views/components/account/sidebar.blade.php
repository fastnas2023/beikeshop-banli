<div class="col-12 col-md-3">
  <div class="account-sides-wrap card glass-card bg-dark bg-opacity-75 border-secondary text-light mb-4">
    <div class="account-sides-info p-3">
      <div class="mb-header d-md-none">
        <h5 class="mb-title mb-0">{{ __('shop/account.index') }}</h5>
        <span class="btn-close btn-close-white" aria-label="Close"></span>
      </div>
...
<style>
.account-sides-wrap .list-group-item:hover {
  background-color: rgba(255,255,255,0.1) !important;
}
.account-sides-wrap .list-group-item.active {
