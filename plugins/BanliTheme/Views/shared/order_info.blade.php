...
<div class="card glass-card mb-lg-4 mb-2 order-head bg-dark bg-opacity-75 border-secondary text-light">
  <div class="card-header border-secondary d-flex align-items-center justify-content-between">
    ...
    <div>
      ...
      @if ($order->status == 'shipped')
        <button class="btn btn-neon btn-sm shipped-ed" type="button">{{ __('shop/account/order_info.confirm_receipt') }}</button>
      @endif
  ...
  <div class="card-body">
    ...
    <div class="bg-dark bg-opacity-50 p-2 border border-secondary table-responsive rounded-2">
      @if (!is_mobile())
        <table class="table table-dark table-borderless bg-transparent mb-0">
          <thead>
            <tr>
...
<div class="card glass-card mb-lg-4 mb-2 bg-dark bg-opacity-75 border-secondary text-light">
  <div class="card-header border-secondary"><h6 class="card-title">{{ __('order.address_info') }}</h6></div>
  <div class="card-body">
...
<div class="card glass-card mb-lg-4 mb-2 bg-dark bg-opacity-75 border-secondary text-light">
  ...
  <div class="card-body">
    <table class="table table-dark table-bordered border-secondary bg-transparent">
      <tbody>
        @foreach (array_chunk($order->orderTotals->all(), 2) as $totals)
          <tr>
            @foreach ($totals as $total)
              <td class="bg-dark bg-opacity-50 wp-200">{{ $total->title }}</td>
...
@if ($order->orderShipments->count())
  ...
  <div class="card glass-card mb-lg-4 mb-2 bg-dark bg-opacity-75 border-secondary text-light">
    <div class="card-header border-secondary"><h6 class="card-title">{{ __('order.order_shipments') }}</h6></div>
    <div class="card-body">
